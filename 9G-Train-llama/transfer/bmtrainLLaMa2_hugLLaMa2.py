...
def transform_to_hf(bmt_model, param_size):
    ...
    model_hf['lm_head.weight'] = bmt_model['lm_head.weight'].contiguous().float()
...
def add_configs(inpath, outpath, base_hf_config):
    ...
    hf_config["vocab_size"] = bmt_config["vocab_size"]
    ...
    hf_config["num_key_value_heads"] = bmt_config["num_kv_heads"]
    hf_config["num_hidden_layes"] = bmt_config["num_layers"]
    hf_config["hidden_act"] = bmt_config["activate_fn"]
    hf_config["rms_norm_eps"] = bmt_config["eps"]
