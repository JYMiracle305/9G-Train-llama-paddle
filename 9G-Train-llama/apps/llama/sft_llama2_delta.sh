...
EXP_PATH=/home/wanghanqing/projects/exp #改为自己的exp_path
MODEL_NAME="llama2-7b-chat-sft-lora"
...
OPTS+=" --dataset /home/wanghanqing/projects/exp/scripts/bin_data_repeat" #改为自己的数据集路径
...
CMD="torchrun --nnodes=1 --nproc_per_node=8 --rdzv_id=1 --rdzv_backend=c10d --rdzv_endpoint=${MASTER_ADDR}:${MASTER_PORT} ${CPM_PATH}/apps/llama/sft_llama_delta.py ${OPTS}" #使用自己的.py名称
