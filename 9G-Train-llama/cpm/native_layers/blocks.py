...
class SelfAttentionBlock(paddle.autograd.PyLayer):
...
class FFNBlock(paddle.autograd.PyLayer):
...
class TransformerBlock(paddle.autograd.PyLayer):
    ...
    def forward(
        ...
        self_attention_mask: paddle.Tensor,
